...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['edit'])) {
        ...
        if ($row->fetch(PDO::FETCH_ASSOC)) {
            print"<p class='errMsg'>Error. Este jugador ya tiene este campeon </p>";
        } else {
...
if (isset($_GET['edit'])) {
    ...
    print "</form>";
    print "<p><a href='" . $_SERVER['PHP_SELF'] . "?" . "'>Volver a nuevo campeon por jugador</a></p>";
} else { ?>
    <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
        <p><strong>Nuevo Campeon por jugador</strong></p>
